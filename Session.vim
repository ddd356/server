...
exe 'vert 3resize ' . ((&columns * 66 + 104) / 209)
exe '4resize ' . ((&lines * 28 + 24) / 48)
exe 'vert 4resize ' . ((&columns * 142 + 104) / 209)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 36 - ((5 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 212 - ((22 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
212
...
badd +10 src\Env.hs
badd +0 test\Spec.hs
badd +535 .\src\RequestProcessors.hs
badd +138 .\src\App.hs
badd +29 stack.yaml
badd +27 app\Main.hs
badd +1 package.yaml
